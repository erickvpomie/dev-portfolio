			...
			<main className='w-full mt-[5.5rem] flex flex-col gap-10 items-center max-w-5xl px-5 xl:max-w-7xl'>
				<section className='w-full grid auto-rows-[192px] grid-cols-6 gap-4'>
					...
					>
						...
						<div className='w-24 h-24 bg-[#98d0ff] absolute z-[1] rounded-full bg-opacity-30 border-2 border-white animate__animated animate__pulse animate__infinite infinite' />
					</motion.div>
				</section>
